...
public class StructureGenerator
{
  protected static HashMap<String, KeyData[]> constructAttrTable()
  {
    ...
    frame.add(new KeyData("sound", KeyData.STRING));
    ...
    frame.add(new KeyData("text", KeyData.STRING));
    ...
    advance_from.add(new KeyData("unit", KeyData.STRING));
    ...
    base_unit.add(new KeyData("id", KeyData.STRING));
